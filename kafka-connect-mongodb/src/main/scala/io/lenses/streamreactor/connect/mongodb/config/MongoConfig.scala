...
object MongoConfig {
  ...
  val config = new ConfigDef()
    .define(
      ...
      Type.STRING,
      Importance.HIGH,
      MongoConfigConstants.CONNECTION_CONFIG_DOC,
      "Connection",
      1,
    ...
    .define(
      ...
      Type.STRING,
      Importance.HIGH,
      MongoConfigConstants.DATABASE_CONFIG_DOC,
      "Connection",
      2,
    ...
    .define(
      ...
      Type.STRING,
      MongoConfigConstants.USERNAME_CONFIG_DEFAULT,
      Importance.MEDIUM,
      MongoConfigConstants.USERNAME_CONFIG_DOC,
      "Connection",
      3,
      ConfigDef.Width.MEDIUM,
      MongoConfigConstants.USERNAME_CONFIG,
    ...
    .define(
      ...
      Type.PASSWORD,
      MongoConfigConstants.PASSWORD_CONFIG_DEFAULT,
      Importance.MEDIUM,
      MongoConfigConstants.PASSWORD_CONFIG_DOC,
      "Connection",
      4,
      ConfigDef.Width.MEDIUM,
      MongoConfigConstants.PASSWORD_CONFIG,
    ...
    .define(
      ...
      Type.STRING,
      MongoConfigConstants.AUTHENTICATION_MECHANISM_DEFAULT,
      Importance.MEDIUM,
      MongoConfigConstants.AUTHENTICATION_MECHANISM_DOC,
      "Connection",
      5,
      ConfigDef.Width.MEDIUM,
      MongoConfigConstants.AUTHENTICATION_MECHANISM,
    ...
    .define(
      MongoConfigConstants.KCQL_CONFIG,
      Type.STRING,
      Importance.HIGH,
      MongoConfigConstants.KCQL_DOC,
      "Mappings",
      1,
      ConfigDef.Width.LONG,
      MongoConfigConstants.KCQL_CONFIG,
    ...
    .define(
      ...
      "",
      Importance.LOW,
      MongoConfigConstants.JSON_DATETIME_FIELDS_DOC,
      "Mappings",
      1,
    ...
    .define(
      ...
      Type.STRING,
      MongoConfigConstants.ERROR_POLICY_DEFAULT,
      Importance.HIGH,
      MongoConfigConstants.ERROR_POLICY_DOC,
      "Error",
      1,
      ConfigDef.Width.LONG,
      MongoConfigConstants.ERROR_POLICY_CONFIG,
    ...
    .define(
      ...
      Type.INT,
      MongoConfigConstants.NBR_OF_RETIRES_DEFAULT,
      Importance.MEDIUM,
      MongoConfigConstants.NBR_OF_RETRIES_DOC,
      "Error",
      2,
      ConfigDef.Width.LONG,
      MongoConfigConstants.NBR_OF_RETRIES_CONFIG,
    ...
    .define(
      ...
      Type.INT,
      MongoConfigConstants.ERROR_RETRY_INTERVAL_DEFAULT,
      Importance.MEDIUM,
      MongoConfigConstants.ERROR_RETRY_INTERVAL_DOC,
      "Error",
      3,
      ConfigDef.Width.LONG,
      MongoConfigConstants.ERROR_RETRY_INTERVAL_CONFIG,
    ...
    .define(
      MongoConfigConstants.PROGRESS_COUNTER_ENABLED,
      Type.BOOLEAN,
      MongoConfigConstants.PROGRESS_COUNTER_ENABLED_DEFAULT,
      Importance.MEDIUM,
      MongoConfigConstants.PROGRESS_COUNTER_ENABLED_DOC,
      "Metrics",
      1,
      ConfigDef.Width.MEDIUM,
      MongoConfigConstants.PROGRESS_COUNTER_ENABLED_DISPLAY,
    )
